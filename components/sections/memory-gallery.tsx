...
function TiltCard({
  ...
  return (
    <motion.button
      ...
      whileHover={{ rotate: index % 2 ? 1.5 : -1.5, scale: 1.02 }}
      className="group relative mb-4 block w-full overflow-hidden rounded-3xl shadow-sm"
    ...
    <Section id="gallery">
      ...
      <Reveal delay={0.1}>
        <p className="mt-4 max-w-md text-center text-muted-foreground">
          A little wall of favorites. Swap these placeholders for real photos
          and clips whenever you like.
        </p>
      </Reveal>
